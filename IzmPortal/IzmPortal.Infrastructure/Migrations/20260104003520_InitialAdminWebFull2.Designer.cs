...
namespace IzmPortal.Infrastructure.Migrations
{
    ...
    [Migration("20260104003520_InitialAdminWebFull2")]
    partial class InitialAdminWebFull2
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("ApplicationShortcut", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                    ...
                    b.ToTable("ApplicationShortcuts", (string)null);
                });

            modelBuilder.Entity("IzmPortal.Domain.Entities.AdminAuditLog", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("IzmPortal.Domain.Entities.Announcement", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("IzmPortal.Domain.Entities.Category", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("IzmPortal.Domain.Entities.Announcement", b =>
                {
                    b.HasOne("IzmPortal.Domain.Entities.Category", "Category")
                        .WithMany()
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityUserClaim<string>", b =>
                {
                    b.HasOne("IzmPortal.Infrastructure.Identity.ApplicationUser", null)
                        .WithMany()
