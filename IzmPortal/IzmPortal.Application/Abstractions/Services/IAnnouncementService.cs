...
public interface IAnnouncementService
{
    ...
    Task<Result> CreateAsync(CreateAnnouncementDto dto, string createdBy, CancellationToken ct);
    Task<Result> UpdateAsync(UpdateAnnouncementDto dto, CancellationToken ct);
